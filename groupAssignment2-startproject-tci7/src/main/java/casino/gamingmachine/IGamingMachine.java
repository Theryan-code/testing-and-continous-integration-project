...
public interface IGamingMachine {
     ...
     */
    boolean placeBet(long amountInCents, IGame game, ICashier cashier) throws NoPlayerCardException;
//    boolean placeBet(long amountInCents, IGame game, ICashier cashier) throws NoPlayerCardException;
     ...
     */
    void acceptWinner(BetResult winResult, ICashier cashier) throws InvalidAmountException;
    ...
    IGamblerCard getGamblerCardConnected();
