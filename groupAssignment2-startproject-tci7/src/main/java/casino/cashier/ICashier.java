...
public interface ICashier {
     ...
     */
    long returnCardAmount(IGamblerCard iGamblerCard);
     ...
     */
    void RecordCardManually(IGamblerCard iGamblerCard, MoneyAmount moneyAmount);
     ...
     */
    int getIndexByCardId(CardID cardID);
}
