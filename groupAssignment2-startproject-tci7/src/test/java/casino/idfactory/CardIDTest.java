...
public class CardIDTest {
    ...
    private Object[] equalObjectsProvider() {
        ...
        return new Object[]{
                new Object[]{new CardID(uuid, instant), new CardID(uuid, instant), new CardID(uuid, instant)}
        };
    }
    ...
    private Object[] sortedComparablesProvider() throws InterruptedException {
        ...
        return new Object[]{
                new Object[]{cardID1, cardID2, cardID3}
        };
    }
    ...
    private Object[] unsortedComparablesProvider() throws InterruptedException {
        ...
        return new Object[]{
                new Object[]{cardID2, cardID1, cardID3}
        };
    }
