...
public class BettingRoundIDTest {
    ...
    private Object[] equalObjectsProvider() {
        ...
        return new Object[]{
                new Object[]{new BettingRoundID(uuid, instant), new BettingRoundID(uuid, instant), new BettingRoundID(uuid, instant)}
        };
    }
    ...
    private Object[] sortedComparablesProvider() throws InterruptedException {
        BettingRoundID betID1 = new BettingRoundID();
        TimeUnit.SECONDS.sleep(1);
        BettingRoundID betID2 = new BettingRoundID();
        TimeUnit.SECONDS.sleep(1);
        BettingRoundID betID3 = new BettingRoundID();
        TimeUnit.SECONDS.sleep(1);
