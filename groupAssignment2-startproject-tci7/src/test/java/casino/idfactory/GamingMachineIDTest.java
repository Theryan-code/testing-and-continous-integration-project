...
public class GamingMachineIDTest {
    ...
    private Object[] equalObjectsProvider() {
        ...
        return new Object[]{
                new Object[]{new GamingMachineID(uuid, instant), new GamingMachineID(uuid, instant), new GamingMachineID(uuid, instant)}
        };
    }
    ...
    private Object[] sortedComparablesProvider() throws InterruptedException {
        ...
        TimeUnit.SECONDS.sleep(1);
        GamingMachineID gamingMachineID3 = new GamingMachineID();
        TimeUnit.SECONDS.sleep(1);

        return new Object[]{
                new Object[]{gamingMachineID1, gamingMachineID2, gamingMachineID3}
        };
    }
    ...
    private Object[] unsortedComparablesProvider() throws InterruptedException {
        ...
        return new Object[]{
                new Object[]{gamingMachineID2, gamingMachineID1, gamingMachineID3}
        };
    }
